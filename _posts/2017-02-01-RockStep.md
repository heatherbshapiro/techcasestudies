...
![picture of team working]({{ site.baseurl }}/images/rockstep/rs-pbie-working-session.jpg)
...
![pbie-architecture diagram]({{ site.baseurl }}/images/rockstep/rs-pbie-architecture.png)
