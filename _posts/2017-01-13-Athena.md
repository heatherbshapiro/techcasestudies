...
- Tawny Snyder - Co-Founder, COO, Athena Intelligence, Inc. 
...
![Impressive Power Bi Query](/images/Athena/PowerBIQuery.jpeg)
...
An exmple would be a Report targeting the Food Industry:

![Food Industry Report](/images/Athena/FoodTheme.jpeg) 
...
[This Blog Post by Tim Reilly](http://timmyreilly.azurewebsites.net/using-deployment-slot-settings-in-azure-web-apps/) was written as a generic technical guide for using deployment slots and slot settings to test Azure Web Apps before pushing to production. 

![Staging Slots Overview](/images/Athena/stagingslotoverview.PNG)
...
"Thank you Microsoft for this, this has opened up things that I couldn't have imagined 6 months ago." - David Sypnieski CEO 
